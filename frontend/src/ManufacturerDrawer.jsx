                    ...
                    <form id="manufacturer-form" onSubmit={handleSubmit} className="drawer-body-form">
                        ...
                        <div className="card">
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                                ...
                                <div className="form-group">
                                    <label>제조사 구분</label>
                                    <select name="category" value={formData.category || ''} onChange={handleChange} required disabled={!canEdit} style={{ padding: '8px', borderRadius: '4px', border: '1px solid #ccc', width: '100%' }}>
