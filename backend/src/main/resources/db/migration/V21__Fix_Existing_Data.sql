...
UPDATE manufacturers SET manufacturerCode = identificationCode WHERE manufacturerCode IS NULL AND identificationCode IS NOT NULL;
UPDATE manufacturers SET manufacturerCode = 'M-' || id WHERE manufacturerCode IS NULL;
